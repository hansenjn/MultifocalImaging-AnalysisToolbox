...
LocationReferenceArrow = [75 -10 0];
Draft = false;
Start = 2;
Step = 4; 
Frame = Start:Step:1001; % Selecting a round number for display consistent with the colobar
...
%% Plot colorbar
PlotColorbar('GlobalView', 'Time (s)', 2)
...
if Draft
    ...
    exportgraphics(gca, 'HumanSperm_GlobalView.png', 'ContentType', 'image', 'Resolution', 300)  
end
